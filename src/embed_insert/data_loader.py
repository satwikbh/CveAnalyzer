...
def main():
    for year in range(2014, 2025):
        ...
        list_of_records = process_all_cves_in_batches(file_path=file_path,
            batch_size=consts.SENTENCE_ENCODER_BATCH_SIZE)
        ...
        for i in range(0, total, chunk_size):
            ...
            print(f"📦 Inserting {len(chunk)} records from year {year} (chunk {i // chunk_size + 1})")
