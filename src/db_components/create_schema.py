...
def get_milvus_schema() -> CollectionSchema:
    ...
    """
    fields = [FieldSchema(name="cve_id", dtype=DataType.VARCHAR, max_length=20, is_primary=True, ),
              ...
              FieldSchema(name="cve_severity", dtype=DataType.VARCHAR, max_length=64, nullable=True),
